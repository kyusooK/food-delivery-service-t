            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        ...
                        to="/customerServices/customerSupports"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: '고객 지원', 
                description: '고객 지원 서비스를 나타내는 주요 집합', 
                key: 'customerSupports', 
                route: '/customerServices/customerSupports',
                ImageUrl: '',
            },
