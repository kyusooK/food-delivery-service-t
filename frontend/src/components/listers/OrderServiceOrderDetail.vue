<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <FoodItemManager offline label="FoodItems" v-model="item.foodItems" :editMode="false" @change="change" />
            <int offline label="Quantity" v-model="item.quantity" :editMode="false" :key="false" @change="change" />
            <div>
                <String label="SpecialRequests" v-model="item.specialRequests" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
